...
def main():
    """
    Main function to interact with the Checkbook. Provides options to deposit, withdraw, 
    check balance, or exit the program. Handles invalid inputs to prevent crashes.
    """
    cb = Checkbook()
    while True:
